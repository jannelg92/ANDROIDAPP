...
public class CalendarDetailsAdapter extends BaseAdapter {
    ...
    private ArrayList<CalendarDetailsModel> CalendarDetailsModel;
     
    public CalendarDetailsAdapter(Context context, ArrayList<CalendarDetailsModel> arrayList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView txtName = (TextView) convertView.findViewById(R.id.details_name);
        TextView txtDate = (TextView) convertView.findViewById(R.id.details_date);  
      //  imgBtn.setImageResource(CalendarDetailsModel.getRSVP());        
