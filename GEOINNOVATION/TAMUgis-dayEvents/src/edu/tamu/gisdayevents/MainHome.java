...
public class MainHome extends FragmentActivity
{
  //  private NavigationDrawerFragment dlDrawer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     // enabling action bar app icon and behaving it as toggle button
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                ...
                R.string.nav_drawer, // nav drawer open - description for accessibility
     ...
     * */
    private class navMenuClickListener implements
	...
	private void displayView(int position) {
        ...
        case 0:
//Home
        	displayView(R.layout.main_home);
        	mDrawerLayout.closeDrawer(mDrawerList);
            break;
        case 1:
//Log Options to Signup or Login
      //  	fragment = new MainLogOptions();
        	fragment = new MainLogOptions();
        //	 mDrawerLayout.closeDrawer(mDrawerList);
            break;
        case 2:
//Event Calendar listview
       ...
       // 	displayView(R.layout.f_event_calendar);
        //	mDrawerLayout.closeDrawer(mDrawerList);
      //fragment = new PhotosFragment();
            break;
        case 3:
//Event Check-in layout
